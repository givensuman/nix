...
Usage of this system is centered around a "world" directory at `$HOME/world`. This holds the flake and dotfiles, as well as a [Justfile](./Justfile) for abstracting away Nix commands and scripts for managing the system, accessible via the `world` wrapper [function](./nixos/modules/world.nix).
